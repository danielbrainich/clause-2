        ...
        <nav className="bg-slate-50">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between p-4">
                    <img src="/bill-logo.png" alt="Image of a cartoon bill" className="w-14 mr-5" />
                    <Link href="/" className={`self-center ultra font-medium text-xl text-indigo-500 whitespace-nowrap mr-10`}>Capitol View</Link>
                ...
                {!session && (
                    <Link className="hover:text-indigo-700 underline-animation nav-link" href="/login">Login</Link>
                )}
                {session?.user?.image && (
                    <>
                        <SignOutButton />
